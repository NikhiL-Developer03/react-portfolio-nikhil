        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          >
            <div className="text-center">
              <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-white">15+</h3>
              <p className="text-neutral-400 text-xs sm:text-sm">Projects</p>
            </div>
            <div className="text-center">
              <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-white">2+</h3>
              <p className="text-neutral-400 text-xs sm:text-sm">Years Exp.</p>
            </div>
            <div className="text-center">
              <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-white">50+</h3>
